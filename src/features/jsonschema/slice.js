...
const mySlice = createSlice({
   ...
   reducers: {
      processingJsonschema: processingReducer,
      processingJsonschemaFailed: processingFailedReducer,
      gotJsonschemas: gotReducer,
      addedJsonschema: addedReducer,
      updatedJsonschema: updatedReducer,
      deletedJsonschema: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingJsonschema, processingJsonschemaFailed, gotJsonschemas, addedJsonschema, updatedJsonschema, deletedJsonschema } = mySlice.actions;
