...
const mySlice = createSlice({
   ...
   reducers: {
      processingDestination: processingReducer,
      processingDestinationFailed: processingFailedReducer,
      gotDestinations: gotReducer,
      addedDestination: addedReducer,
      updatedDestination: updatedReducer,
      deletedDestination: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingDestination, processingDestinationFailed, gotDestinations, addedDestination, updatedDestination, deletedDestination } = mySlice.actions;
