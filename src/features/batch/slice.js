...
const mySlice = createSlice({
   ...
   reducers: {
      processingBatch: processingReducer,
      processingBatchFailed: processingFailedReducer,
      gotBatches: gotReducer,
      addedBatch: addedReducer,
      updatedBatch: updatedReducer,
      deletedBatch: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingBatch, processingBatchFailed, gotBatches, addedBatch, updatedBatch, deletedBatch } = mySlice.actions;
