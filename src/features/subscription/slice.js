...
const mySlice = createSlice({
   ...
   reducers: {
      processingSubscription: processingReducer,
      processingSubscriptionFailed: processingFailedReducer,
      gotSubscriptions: gotReducer,
      addedSubscription: addedReducer,
      updatedSubscription: updatedReducer,
      deletedSubscription: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingSubscription, processingSubscriptionFailed, gotSubscriptions, addedSubscription, updatedSubscription, deletedSubscription } = mySlice.actions;
