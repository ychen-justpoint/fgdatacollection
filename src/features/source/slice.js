...
const mySlice = createSlice({
   ...
   reducers: {
      processingSource: processingReducer,
      processingSourceFailed: processingFailedReducer,
      gotSources: gotReducer,
      addedSource: addedReducer,
      updatedSource: updatedReducer,
      deletedSource: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingSource, processingSourceFailed, gotSources, addedSource, updatedSource, deletedSource } = mySlice.actions;
