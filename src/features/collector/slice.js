...
const mySlice = createSlice({
   ...
   reducers: {
      processingCollector: processingReducer,
      processingCollectorFailed: processingFailedReducer,
      gotCollectors: gotReducer,
      addedCollector: addedReducer,
      updatedCollector: updatedReducer,
      deletedCollector: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingCollector, processingCollectorFailed, gotCollectors, addedCollector, updatedCollector, deletedCollector } = mySlice.actions;
