...
const mySlice = createSlice({
   ...
   reducers: {
      processingJsondata: processingReducer,
      processingJsondataFailed: processingFailedReducer,
      gotJsondatas: gotReducer,
      addedJsondata: addedReducer,
      updatedJsondata: updatedReducer,
      deletedJsondata: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingJsondata, processingJsondataFailed, gotJsondatas, addedJsondata, updatedJsondata, deletedJsondata } = mySlice.actions;
