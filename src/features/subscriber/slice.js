...
const mySlice = createSlice({
   ...
   reducers: {
      processingSubscriber: processingReducer,
      processingSubscriberFailed: processingFailedReducer,
      gotSubscribers: gotReducer,
      addedSubscriber: addedReducer,
      updatedSubscriber: updatedReducer,
      deletedSubscriber: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingSubscriber, processingSubscriberFailed, gotSubscribers, addedSubscriber, updatedSubscriber, deletedSubscriber } = mySlice.actions;
