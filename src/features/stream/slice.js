...
const mySlice = createSlice({
   ...
   reducers: {
      processingStream: processingReducer,
      processingStreamFailed: processingFailedReducer,
      gotStreams: gotReducer,
      addedStream: addedReducer,
      updatedStream: updatedReducer,
      deletedStream: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingStream, processingStreamFailed, gotStreams, addedStream, updatedStream, deletedStream } = mySlice.actions;
