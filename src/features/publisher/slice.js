...
const mySlice = createSlice({
   ...
   reducers: {
      processingPublisher: processingReducer,
      processingPublisherFailed: processingFailedReducer,
      gotPublishers: gotReducer,
      addedPublisher: addedReducer,
      updatedPublisher: updatedReducer,
      deletedPublisher: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingPublisher, processingPublisherFailed, gotPublishers, addedPublisher, updatedPublisher, deletedPublisher } = mySlice.actions;
