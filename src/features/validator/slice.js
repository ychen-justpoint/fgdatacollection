...
const mySlice = createSlice({
   ...
   reducers: {
      processingValidator: processingReducer,
      processingValidatorFailed: processingFailedReducer,
      gotValidators: gotReducer,
      addedValidator: addedReducer,
      updatedValidator: updatedReducer,
      deletedValidator: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingValidator, processingValidatorFailed, gotValidators, addedValidator, updatedValidator, deletedValidator } = mySlice.actions;
