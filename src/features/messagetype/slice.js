...
const mySlice = createSlice({
   ...
   reducers: {
      processingMessagetype: processingReducer,
      processingMessagetypeFailed: processingFailedReducer,
      gotMessagetypes: gotReducer,
      addedMessagetype: addedReducer,
      updatedMessagetype: updatedReducer,
      deletedMessagetype: deletedReducer,
      updateSearchstate : updateSearchstateReducer
   }
});

export const { updateSearchstate,processingMessagetype, processingMessagetypeFailed, gotMessagetypes, addedMessagetype, updatedMessagetype, deletedMessagetype } = mySlice.actions;
